        ...
        <div className="py-8">
          ...
          <div className="text-center md:flex md:items-center md:justify-between">
            ...
            <ul className="inline-flex mb-4 md:order-1 md:ml-4 md:mb-0 space-x-2">
              <li>
                <a
                  className="flex justify-center items-center text-sky-400 hover:text-sky-400 transition duration-150 ease-in-out"
                  href="#0"
                  aria-label="Twitter"
                >
                  <svg
            ...
            <div className="text-sm text-slate-600">
              Copyright © Beyond Bytes. All rights reserved.
            </div>
          </div>
        </div>
      </div>
